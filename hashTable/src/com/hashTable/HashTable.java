...
public class HashTable {
	...
	private int numOfBuckets; // capacity of the array
	...
	private class HashNode { // HashNode hocche LinkList er moto..samne key thake, majhe value thake, r
								// seshe porer node er reference hisebe .next thake
    ...
    public String get(Integer key) { // search er moto kaj kore
    	if(key == null){
